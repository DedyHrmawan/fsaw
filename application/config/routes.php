...
$route['nilaipegawai'] = 'Welcome/VPegawaiWaka';
$route['kriteria-pendidikan'] = 'Welcome/VKriteriaPendidikan';
$route['kriteria-testulis'] = 'Welcome/VKriteriaTesTulis';
$route['kriteria-wawancara'] = 'Welcome/VKriteriaWawancara';
$route['kriteria-praktik'] = 'Welcome/VKriteriaPraktik';
$route['kriteria-btq'] = 'Welcome/VKriteriaBtq';

$route['perangkingan'] = 'Welcome/VPerangkingan';

// Kepsek 
$route['ranking'] = 'Welcome/VRanking';
$route['penentuan'] = 'Welcome/VPenentuan';
$route['dashboard-kepsek'] = 'Welcome/VDashboardKepsek';
